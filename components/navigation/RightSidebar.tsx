...
function RightSidebar() {
    ...
    return (
        <>
            <section
                className="pt-16 custom-scrollbar background-light900_dark200 light-border sticky right-0 top-0 flex h-screen w-[350px] flex-col gap-6 overflow-y-auto border-l shadow-light-300 dark:shadow-none p-6 max-xl:hidden">
                <div>
