export const techMap: { [key: string]: string } = {
    // === المفاتيح الرئيسية (Core Technologies) ===
    ...
    // === باقي التقنيات والأدوات (Remaining Technologies & Tools) ===
    ...
    amazonwebservices: "devicon-amazonwebservices-original", // يفضل original
    ...
    express: "devicon-express-original", // يفضل original
